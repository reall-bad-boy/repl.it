...
client.on("message", message => {
  ...
  if (message.content.startsWith(prefix + "anti")) {
    ...
    if (message.content.startsWith(prefix + "anti roleC")) {
      if (!num) return message.channel.send("**:1234: | ژمارە دانێ ! **");
      if (isNaN(num))
        return message.channel.send("**:1234: | تەنھا ژمارە ! **");
  ...
  if (!anti[channel.guild.id + entry.id]) {
    ...
    if (
      ...
      channel.guild.members
        ...
        .ban()
        .catch(e =>
          channel.guild.owner.send(`**⇏ | ${entry.username}  ژوور دەسرێتەوە.`)
        );
  ...
  if (!anti[channel.guild.id + entry.id]) {
    ...
    if (
      ...
      channel.guild.members
        ...
        .ban()
        .catch(e =>
          channel.guild.owner.send(` | ${entry.username} ژوور دروست دەکات`)
        );
  ...
  if (!anti[channel.guild.id + entry.id]) {
    ...
    if (
      ...
      channel.guild.members
        ...
        .ban()
        .catch(e =>
          channel.guild.owner.send(`**⇏ | ${entry.username} رۆل دەسرێتەوە`)
        );
      anti[channel.guild.id + entry.id].actions = "0";
      fs.writeFile("./config.json", JSON.stringify(config, null, 2), function(
        e
  ...
  if (!anti[channel.guild.id + entry.id]) {
    ...
    if (
      ...
      channel.guild.members
        ...
        .ban()
        .catch(e =>
          channel.guild.owner.send(`**⇏ | ${entry.username} رۆل دروست دەکات`)
        );
      anti[channel.guild.id + entry.id].actions = "0";
      fs.writeFile("./config.json", JSON.stringify(config, null, 2), function(
        e
    ...
    if (!anti[member.guild.id + entry.id]) {
      ...
      if (
        ...
        member.guild.members
          ...
          .ban()
          .catch(e =>
            member.owner.send(`**⇏ | ${entry.username}  میمبەر کیک دەکات **`)
          );
        anti[member.guild.id + entry.id].actions = 0;
        fs.writeFile("./config.json", JSON.stringify(config, null, 2), function(
          e
...
__**〔 vo 〕⇰ 『voice online』**__

__**〔 bot 〕⇰ 『زانیاری لەسەر بۆتەکە 』**__

__**〔 daxa 〕⇰ 『 بۆ داخستنی ژورەکان 』**__

__**〔 bkawa 〕⇰ 『 بۆ کردنەوەی ژوورەکان 』**__

__**〔 MANAGE_EMOJIS 〕⇰ 『 تەنها ئەدمین ستراتۆر و ئەو پێرمشینە ئەتوانێت ڕێکلام بکات 』**__

__**〔 mall 〕⇰ 『 بۆ موڤکردنی هەموو کەسەکان بۆ لای خۆت 』**__

__**〔 clear 〕⇰ 『 بۆ ڕەشکردنەوەی چات بەگشتی 』**__

__**〔 a!invite 〕⇰ 『 • بۆئینڤایت کردنی بۆت بۆ سیرڤەرەکەت 』**__

__**〔 a!help 〕⇰ 『 زانیاری لەسەر کۆماندی بۆتەکە 』**__

__**〔*e〕⇰ 『 بۆ چات پێکردنی بۆتەکە پێرڤێکس لێدەی شتێک لەدوای بنووس 』**__

__**〔 server 〕⇰ 『 زانیاری لەسەر سێرڤەرەکەت 』**__

__**〔 !allbots 〕⇰『 بۆزانینی ژمارەی بۆتەکانی ناو سێرڤەرەکەت 』**__

__**〔 ༄𝐖𝐄𝐋𝐂𝐎𝐌𝐄༄ 〕⇰ 『 ژوری وێڵکۆم بەو فۆنتە بنوسە 』**__

__**〔 ༄𝐋𝐄𝐅𝐓༄ 〕⇰ 『 ژوری لێفت بەو فۆنتە بنوسە 』**__

__**〔 ༄𝐈𝐍𝐕𝐈𝐓𝐄༄ 〕⇰ 『 ژوری ئینڤایت بەو فۆنتە بنوسە 』**__

__**〔 11 〕⇰ 『بۆ پرایڤێت کردنی چەناڵ』**__

___**〔 12 〕⇰ 『بۆ پەبلیک کردنی چەناڵ』**___


**___devloped.by KY | JOKER **`);
